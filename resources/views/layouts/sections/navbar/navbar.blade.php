                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                ...
                                <div class="avatar avatar-online">
                                    @if(Auth::check())
                                    <img src="{{ Auth::user()->image ? asset('uploads/students/' . Auth::user()->image) : 'https://www.w3schools.com/howto/img_avatar.png' }}" alt="User Avatar" width="50" height="50" style="border-radius: 50%;">
                                @else
                                    <img src="https://www.w3schools.com/howto/img_avatar.png" alt="Default Avatar" width="50" height="50" style="border-radius: 50%;">
                                @endif
