...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <div>
            <h4 class="fw-bold py-3 mb-4">
                <span
                    class="text-muted fw-light">{{ $type == 'music' ? 'Music' : 'Song' }}/</span>{{ $type == 'music' ? 'All Music' : 'All Songs' }}
            </h4>
        </div>
    ...
    {{-- Create Music model --}}
    <x-modal id="createmusicModal" title="{{ $type == 'music' ? 'Create Music' : 'Create Songs' }}" saveBtnText="Create"
