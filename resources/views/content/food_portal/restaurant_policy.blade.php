...
<div class="d-flex justify-content-between">
    <div>
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Restaurant /</span> <span class="text-muted fw-light">Settings /</span> Restaurant Policy
        </h4>
    </div>
    <div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel3">Add Restaurant Policy</h4>
                ...
                <div class="row">
                    <form id="createForm" method="POST" action="https://dash.yekbun.net/policy_and_terms">
                        <input type="hidden" name="_token" value="V2lq7LnYKWUj06x45EduYQqoEtDMGhg0pawfatwM">                        <div class="col mb-3">
                            <label for="nameLarge" class="form-label">Restaurant Policy Name</label>
...
<div class="row">
    <h6 class="text-muted">Delivery Policy and Terms</h6>
