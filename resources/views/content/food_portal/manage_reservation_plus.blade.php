...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Restaurant /</span> Reservation Plus
</h4>
                ...
                <div class="row gy-4 gy-sm-1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                                    <div>
                                        <h3 class="mb-2">10</h3>
                                        <p class="mb-0">New Reservations</p>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0">
                                    <div>
                                        <h3 class="mb-2">5</h3>
                                        <p class="mb-0">Preparation for Today</p>
                                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                            <div>
                                <h3 class="mb-2">10</h3>
                                <p class="mb-0">Accepted Reservation</p>
                            </div>
                            <div class="avatar me-sm-4">
                                <span class="avatar-initial rounded bg-label-secondary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                                    <div>
                                        <h3 class="mb-2">10</h3>
                                        <p class="mb-0">Canceled Reservation</p>
                                    </div>
                                    <div class="avatar me-sm-4">
                                        <span class="avatar-initial rounded bg-label-secondary">
                                            <i class="bx bx-error-alt bx-sm"></i>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                                    <div>
                                        <h3 class="mb-2">10</h3>
                                        <p class="mb-0">Rejected Reservation</p>
                                    </div>
                                    <div class="avatar me-sm-4">
                                        <span class="avatar-initial rounded bg-label-secondary">
                                            <i class="bx bx-error-alt bx-sm"></i>
