...
/*    background-image: url("{{asset('assets/img/NewProject.png')}}") !important;*/
  ...
  <div class="card-body">
    <div class="d-flex align-items-start justify-content-between">
      <div class="content-left">
        <span>Total New Shop Requests</span>
...
<div class="card">
  <div class="card-body">
    <div class="d-flex align-items-start justify-content-between">
      <div class="content-left">
        <span>Total Rejected Shops</span>
        <div class="d-flex align-items-end mt-2">
...
<div style="margin-left: 20px;"  class="card">
  ...
  <li class="nav-item" role="presentation">
    <a type="button" class="nav-link {{ $view === 'new_request'? 'active': '' }}" href="?view=new_request" aria-selected="true"><i class="tf-icons bx bxs-edit me-1"></i> New Shop Request</a>
...
<th class="text-nowrap sorting sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 132px;" aria-label="Customer Id: activate to sort column descending" aria-sort="ascending">
    Shop Id</th>
<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 280px;" aria-label="Customer: activate to sort column ascending">Shop Name
</th>

<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 280px;" aria-label="Customer: activate to sort column ascending">Request Date
</th>

<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 280px;" aria-label="Customer: activate to sort column ascending">Country City
</th>


<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 280px;" aria-label="Customer: activate to sort column ascending">Customer Details
</th>


<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 225px;" aria-label="Country: activate to sort column ascending">Reject Reason
</th>
<!--<th>Event Title</th>-->
<!--<th>Event Type</th>-->
<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 225px;" aria-label="Country: activate to sort column ascending">Option
                ...
                <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td class="sorting_1"><span class="">RP-031236</span></td>
                        <td class="">
                        ...
                        <td class="sorting_1"><span class="">12.10.2024 - 19:00</span></td>

                        <td class="sorting_1"><span class="">Country - City</span></td>
                        ...
                        <td class="">
                            <div class="d-flex justify-content-start align-items-center customer-name">
                                ...
                                <div class="d-flex flex-column"><span class="fw-medium">Cristine Easom</span><small class="text-muted">cristine@demo.gov</small></div>
                            </div>
...
<th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 225px;" aria-label="Country: activate to sort column ascending">Option
                ...
                <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td class="control dtr-hidden" tabindex="0" style="display: none;"></td>                        
                        <td class="sorting_1"><span class="">RP-03123456</span></td>
                        <td class="">
                            <div class="d-flex justify-content-start align-items-center customer-name">
                                <div class="avatar-wrapper">
                                    <div class="avatar me-2"><span class="avatar-initial rounded-circle bg-label-warning">RC</span></div>
                        ...
                        <td>
                            <span class=" text-warning"> <i class="fa-solid fa-circle text-warning"></i> Pending</span>
                        </td>
...
<!--  <div style="margin-left:20px;" class="col-12 mt-3">-->
<!--  <div class="card">-->
...
<!--                <label class="form-label" for="form-repeater-1-1">Notifications</label>-->
