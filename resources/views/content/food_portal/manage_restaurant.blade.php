    ...
    <div style="margin-left: 20px;"  class="card">
     ...
     <!-- <ul class="nav nav-tabs nav-fill" role="tablist">
      <li class="nav-item" role="presentation">
        <a type="button" class="nav-link " href="" aria-selected="true"><i class="tf-icons bx bxs-edit me-1"></i> Active Shops</a>
        <div class=" tab__slider"></div>
      </li>
      <li class="nav-item" role="presentation">
        <a type="button" class="nav-link " href="" aria-selected="false" tabindex="-1"><i class="tf-icons bx bxs-edit me-1"></i> Blocked Shops</a>
        <div class="tab__slider"></div>
      </li>
                        ...
                        <tr>
                           ...
                           <!-- <th class="sorting_disabled dt-checkboxes-cell dt-checkboxes-select-all" rowspan="1" colspan="1" style="width: 18px;" data-col="1" aria-label=""><input type="checkbox" class="form-check-input"></th>-->
                            <th class="text-nowrap sorting sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 132px;" aria-label="Customer Id: activate to sort column descending" aria-sort="ascending">
                                #</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 280px;" aria-label="Customer: activate to sort column ascending">Country
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 225px;" aria-label="Country: activate to sort column ascending">Total Restaurants
                            </th>
                            <!--<th>Event Title</th>-->
                            <!--<th>Event Type</th>-->
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 225px;" aria-label="Country: activate to sort column ascending">Total Activated Restaurants
                            </th>
							
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 225px;" aria-label="Country: activate to sort column ascending">Total Deactivated Restaurants
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td class="sorting_1"><span class="fw-medium text-heading">#1</span></td>
                            <td class="">
                            ...
                            <td>                                								
								<span > <a href="{{ route('food_portal.total_restaurant') }}"> 1204</a> </span>
                            </td>
