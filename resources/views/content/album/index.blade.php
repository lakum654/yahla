            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td>{{++$key}}</td>
                        <td>
                            {{$value?->artist->first_name}} {{$value?->artist->last_name}}
                        </td>
                        <td>
                            -
                            {{-- @dd(explode(',',$value->album)[0]) --}}
                            <audio controls>
                                <source src="{{ asset('storage/'.$value->album[0]) }}" /></audio>
                        </td>
                        <td> {{count($value->album)}}</td>
                        <td>
                            <div class="d-flex justify-content-start align-items-center">
                                ...
                                <form action="{{ route('album.destroy',$value['_id'])}}"
                                ...
                                <div class="modal fade modal-659be65767b5f" id="editalbumModal3" aria-modal="true"
                                    role="dialog">
                                    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm3" method="POST" action="https://dash.yekbun.net/album/3"
                                                    enctype="multipart/form-data">
                                                    <input type="hidden" name="_token"
                                                        value="vZWRWLao4mkM3TaLxw8oI60YJ7wrJHownfBORslo"> <input
                                                        type="hidden" name="_method" value="put">
                                                    <div class="hidden-inputs">

                                                        <input type="hidden" name="album[]"
                                                            value="music/64fdbcd8dfe8d___RABEE01.MP3"
                                                            data-path="music/64fdbcd8dfe8d___RABEE01.MP3">
                                                        <input type="hidden" name="album[]"
                                                            value="music/64fdbcda5460c___RABEE02.MP3"
                                                            data-path="music/64fdbcda5460c___RABEE02.MP3">
                                                        <input type="hidden" name="album[]"
                                                            value="music/64fdbcdbb4c6f___RABEE03.MP3"
                                                            data-path="music/64fdbcdbb4c6f___RABEE03.MP3">
                                                        <input type="hidden" name="album[]"
                                                            value="music/64fdbcdd34cc3___RABEE04.MP3"
                                                            data-path="music/64fdbcdd34cc3___RABEE04.MP3">
                                                        <input type="hidden" name="album[]"
                                                            value="music/64fdbcdf3446d___RABEE06.MP3"
                                                            data-path="music/64fdbcdf3446d___RABEE06.MP3">
                                                        <input type="hidden" name="album[]"
                                                            value="music/64fdbce066b00___RABEE08.MP3"
                                                            data-path="music/64fdbce066b00___RABEE08.MP3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 mx-auto">
                                                            <div class="row g-3">
                                                                <div class="col-md-12">
                                                                    <label class="form-label" for="fullname">Album
                                                                        Title</label>
                                                                    <input type="text" id="audio3"
                                                                        class="form-control"
                                                                        placeholder="Title will add automatically"
                                                                        name="title" value="RABEE08.MP3"
                                                                        readonly="">
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <label class="form-label"
                                                                        for="fullname">Artist</label>
                                                                                            ...
                                                                                            <div class="dz-details">
                                                                                                <div class="dz-thumbnail"
                                                                                                    style="width:95%"> <img
                                                                                                        ...
                                                                                                        class="w-100"
                                                                                                        alt="undefined"
                                                                                                        src="https://dash.yekbun.net/storage">
                                                                                                    <span
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" form="editForm3" class="btn btn-primary"
