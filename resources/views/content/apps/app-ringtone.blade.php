...
<style>
    ...
    @php
        $ringtones = \App\Models\Ringtone::get();
    @endphp
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <h4 class="fw-bold py-3 mb-4">
                        <span class="text-muted fw-light">App Setting/</span> Message Ringtone
                    </h4>
                </div>
                <div class="">
                    ...
                    <table class="table">
                        ...
                        @foreach ($ringtones as $ringtone)
                            <tr>
                                ...
                                <td>
                                    @php
                                    $url = url('storage/'.$ringtone->ringtone_path);
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-icon" data-bs-toggle="modal" data-bs-target="#editRingtoneModal" data-id="{{ $ringtone->id }}" data-title="{{ $ringtone->title }}" data-file="{{ $cleanUrl }}">
                                        ...
                                        <form action="{{ route('ringtone.delete-ringtone', $ringtone->id) }}" onsubmit="confirmAction(event, () => event.target.submit())" method="post" class="d-inline">    
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="modal fade modal-6560a828ec25c" id="createmusicModal" aria-modal="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="createForm" method="POST" action="{{ route('ringtone.store') }}"
     ...
     <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editRingtoneModal.addEventListener('show.bs.modal', function (event) {
                ...
                editRingtoneForm.action = `{{ route('m-ringtone.update', '') }}/${id}`;
