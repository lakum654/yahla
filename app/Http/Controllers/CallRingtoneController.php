...
use App\Models\CallRingtone;

use Illuminate\Http\Request;

class CallRingtoneController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($ringtone->save()){
            ...
            return redirect()->back()->with('danger' , 'Ringtone was not created successfully');
